...
const editProduct = async (product: Product) => {
  try {
    ...
    //   formData.append('image', image, image.name);
    // });
    const response = await axiosAPI.put(`/user/update-product/${product._id}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data',
      },
    });
...
const productService = { getAllProducts, getProduct, addProduct, editProduct, deleteProduct };
