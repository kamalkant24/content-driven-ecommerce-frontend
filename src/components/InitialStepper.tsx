...
const InitialStepper = (props: any) => {
  ...
  const [additionalDetails, setAdditionalDetails] = React.useState<AdditionalDetails>({
    org_Name: "",
    phone: "",
    industry: "",
    org_Size: "",
  ...
  const roleFields = {
    ...
    user: ["phone", "profile_img", "address"] as string[],
  };
  ...
  const handleConfirmation = async () => {
    ...
    formData.append("profile_img", additionalDetails?.profile_img || "");
    // formData.append("org_Banner", additionalDetails?.org_Banner || "");
    formData.append("phone", additionalDetails.phone || "");
    formData.append("address", additionalDetails.address || "");
    formData.append("org_Description", additionalDetails.org_Description || "");
                      ...
                      <div className="w-full">
                        <div className="mx-auto bg-white rounded-md  text-left w-full">
                          <h2 className="text-2xl font-semibold mb-4">
                            {additionalDetails?.role === 'vendor' ? 'Organization' : 'Additional'} Details
                          </h2>
                          <form className="flex flex-wrap justify-between text-sm ">
                            {additionalDetails?.role === 'vendor' && <div className="my-4 w-full lg:w-[47.5%]">
                            ...
                            {additionalDetails?.role === 'vendor' && <div className="my-4 w-full lg:w-[47.5%]">
                              ...
                              <UserInput
                                ...
                                showValue={additionalDetails?.org_Description}
                                className="bg-slate-100  w-full h-12 focus:border-blue-500 px-3 "
                              />
                            </div>}
                          </form>
